...
class LocalNewModelServer:
    """LocalNewModelServer class."""

    def _start_new_model_server(
        self, client: object, image: str, model_path: str, secret_key: str, env_vars: dict
    ):
        """Starts a local new model server container.
    ...
    def _invoke_new_model_server(self, request: object, content_type: str, accept: str):
        """Invokes a local new model server container.
    ...
    def _new_model_server_deep_ping(self, predictor: PredictorBase):
        """Checks if the local new model serverg container is up and running.
...
class SageMakerNewModelServer:
    """SageMakerNewModelServer class."""

    def _upload_new_model_server_artifacts(
        self,
        model_path: str,
